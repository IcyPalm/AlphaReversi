...
public class GameBaseModel {
    ...
    /**
     * Standard constructer for a gameModule. The super of the game modules contains all shared
     ...
     * seperate methode because the sheer amount of times this has to be checked.
     */

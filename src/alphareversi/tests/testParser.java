 ...
 *
 * S: SVR GAMELIST ["<speltype>", ...] S: SVR PLAYERLIST ["<speler>", ...] S: SVR GAME MATCH
 * {GAMTYPE: "<speltype>", PLAYERTOMOVE: "<naam speler1>", OPPONENT: "<naam tegenstander>"} S: SVR
 * GAME YOURTURN {TURNMESSAGE: "<bericht voor deze beurt>"} S: SVR GAME MOVE {PLAYER: "<speler>",
 * DETAILS: "<reactie spel op zet>", MOVE: "<zet>"} S: SVR GAME <speler resultaat> {PLAYERONESCORE:
 * "<score speler1>", PLAYERTWOSCORE: "<score speler2>", COMMENT: "<commentaar op resultaat>"} S:
 * SVR GAME <speler resultaat> {PLAYERONESCORE: "<score speler1>", PLAYERTWOSCORE: "<score
 * speler2>", COMMENT: "Player forfeited match"} S: SVR GAME <speler resultaat> {PLAYERONESCORE:
 * "<score speler1>", PLAYERTWOSCORE: "<score speler2>", COMMENT: "Client disconnected"} S: SVR GAME
 * CHALLENGE {CHALLENGER: "Sjors", GAMETYPE: "Guess Game", CHALLENGENUMBER: "1"} S: SVR GAME
 * CHALLENGE CANCELLED {CHALLENGENUMBER: "<uitdaging nummer>"} S: SVR HELP <help informatie>
 */
